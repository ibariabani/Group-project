...
void Bconds::Problem1(double a, double b){
  ...
  double GS=b, delta=a,r=0,r1=0.5,r2=1.4, V=0,V0=10,x=0,y=0, E=0;
...
ofstream file,efile;                         //Opens a file to write the analytical solution data to
file.open("vAnalytical1");
efile.open("AnalyticalE");
